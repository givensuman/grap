...
/**
 * Highlight and print out a substring
 * within a string, like in grep
 *
 * @param char *line The entire string
 * @param char *target The substring
 * @param int index_of_target The index of the substring
 */
